...
/**
 * CompassBuildingRome Mobile Menu
 *
...
(function( $, undefined ) {
	...
	$.fn.compassbuildingromeMobileMenu = function() {
...
/**
 * JavaScript for CompassBuildingRome
 *
 * Includes all JS which is required within all sections of the theme.
 */
window.compassbuildingrome = window.compassbuildingrome || {};
...
(function( window, $, undefined ) {
	...
	var $document = $( document ),
		$body     = $( 'body' ),
		compassbuildingrome   = window.compassbuildingrome;

	$.extend( compassbuildingrome, {
		...
		globalInit: function() {
			...
			$document.compassbuildingromeMobileMenu();
			$videos.fitVids();
		}
	...
	jQuery(function() {
		skipLinkFocus.init();
		compassbuildingrome.globalInit();
	});
})( this, jQuery );
