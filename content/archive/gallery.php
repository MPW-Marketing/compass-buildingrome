...
<article <?php hybrid_attr( 'post' ); ?>>
	...
	<div <?php hybrid_attr( 'entry-summary' ); ?>>
		...
		<p class="gallery-count"><?php printf( _n( 'This gallery contains %s item.', 'This gallery contains %s items.', $count, 'compassbuildingrome-mpw-rome' ), $count ); ?></p>
	</div><!-- .entry-summary -->
