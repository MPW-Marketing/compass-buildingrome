...
class Flagship_Search_Form {
	...
	protected function get_label() {
		$label = apply_filters( 'flagship_search_form_label', __( 'Search site', 'compassbuildingrome-mpw-rome' ) );
	...
	protected function get_input() {
		...
		$placeholder = apply_filters( 'flagship_search_text', __( 'Search this website', 'compassbuildingrome-mpw-rome' ) );
	...
	protected function get_button() {
		return sprintf(
			...
			esc_attr( apply_filters( 'flagship_search_button_label', __( 'Search', 'compassbuildingrome-mpw-rome' ) ) ),
			esc_attr( apply_filters( 'flagship_search_button_text', __( 'Search', 'compassbuildingrome-mpw-rome' ) ) )
		);
	}
