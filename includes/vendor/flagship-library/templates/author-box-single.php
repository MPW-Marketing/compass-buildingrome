...
<section <?php hybrid_attr( 'author-box', 'single' ); ?>>
	...
	<div class="author-info">
		...
		<h3 class="author-box-title">
			<?php _e( 'Written by', 'compassbuildingrome-mpw-rome' ); ?> <?php the_author_posts_link(); ?>
		</h3>
	...
	<ul class="social-icons">
		...
		<li class="social-twitter">
			<a href="<?php echo esc_url( "https://twitter.com/{$twitter}" ); ?>">
				<span class="text"><?php _e( 'Twitter', 'compassbuildingrome-mpw-rome' ); ?></span>
			</a>
		</li>
		<?php endif; ?>
		...
		<li class="social-gplus">
			<a href="<?php echo esc_url( $gplus ); ?>">
				<span class="text"><?php _e( 'Google+', 'compassbuildingrome-mpw-rome' ); ?></span>
			</a>
		</li>
		<?php endif; ?>
		...
		<li class="social-facebook">
			<a href="<?php echo esc_url( $facebook ); ?>">
				<span class="text"><?php _e( 'Facebook', 'compassbuildingrome-mpw-rome' ); ?></span>
			</a>
		</li>
		<?php endif; ?>
		...
		<li class="social-rss">
			<a href="<?php echo esc_url( get_author_feed_link() ); ?>">
				<span class="text"><?php _e( 'RSS Feed', 'compassbuildingrome-mpw-rome' ); ?></span>
			</a>
		</li>
