...
class Flagship_Author_Box_Admin {
	...
	public function user_contactmethods( array $contactmethods ) {
		$contactmethods['googleplus'] = __( 'Google+', 'compassbuildingrome-mpw-rome' );
		$contactmethods['twitter']    = __( 'Twitter (Without @)', 'compassbuildingrome-mpw-rome' );
		$contactmethods['facebook']   = __( 'Facebook', 'compassbuildingrome-mpw-rome' );
