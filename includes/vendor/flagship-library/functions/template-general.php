...
function flagship_get_post_navigation( $args = array() ) {
	...
	$defaults = apply_filters( 'flagship_get_post_navigation_defaults',
		array(
			...
			'prev_text'      => __( 'Previous', 'compassbuildingrome-mpw-rome' ) . esc_attr( $name ),
			'next_text'      => __( 'Next', 'compassbuildingrome-mpw-rome' ) . esc_attr( $name ),
			'in_same_term'   => false,
			'excluded_terms' => '',
			'taxonomy'       => 'category',
		)
...
function flagship_get_posts_navigation( $args = array() ) {
	...
	$defaults = apply_filters( 'flagship_loop_nav_defaults',
		array(
			'format'         => 'pagination',
			'prev_text'      => sprintf( '<span class="screen-reader-text">%s</span>' , __( 'Previous Page', 'compassbuildingrome-mpw-rome' ) ),
			'next_text'      => sprintf( '<span class="screen-reader-text">%s</span>', __( 'Next Page', 'compassbuildingrome-mpw-rome' ) ),
			'prev_link_text' => __( 'Newer Posts', 'compassbuildingrome-mpw-rome' ),
			'next_link_text' => __( 'Older Posts', 'compassbuildingrome-mpw-rome' ),
		)
	);
...
function flagship_get_credit_link() {
	$link = sprintf( '<a class="author-link" href="%s" title="%s">%s</a>',
		...
		__( 'Purpose-Built WordPress Theme by', 'compassbuildingrome-mpw-rome' ) . ' Flagship',
		'Flagship'
	);
...
function flagship_get_theme_link() {
	$link = sprintf( '<a class="theme-link" href="%s"title="%s">%s</a>',
		...
		__( 'The Most Advanced WordPress Starter Theme Ever Created', 'compassbuildingrome-mpw-rome' ),
