...
class Flagship_Site_Logo_Image_Control extends WP_Customize_Control {
	...
	public function __construct( $wp_customize, $control_id, $args = array() ) {
		...
		$this->l10n = array(
			'upload'      => __( 'Add logo',    'compassbuildingrome-mpw-rome' ),
			'set'         => __( 'Set as logo', 'compassbuildingrome-mpw-rome' ),
			'choose'      => __( 'Choose logo', 'compassbuildingrome-mpw-rome' ),
			'change'      => __( 'Change logo', 'compassbuildingrome-mpw-rome' ),
			'remove'      => __( 'Remove logo', 'compassbuildingrome-mpw-rome' ),
			'placeholder' => __( 'No logo set', 'compassbuildingrome-mpw-rome' ),
		);
