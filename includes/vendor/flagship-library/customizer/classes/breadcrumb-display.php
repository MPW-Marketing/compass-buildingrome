...
class Flagship_Breadcrumb_Display extends Flagship_Customizer_Base {
	...
	public function register( $wp_customize ) {
		...
		$wp_customize->add_section(
			$this->section,
			array(
				'title'       => __( 'Breadcrumbs', 'compassbuildingrome-mpw-rome' ),
				'description' => __( 'Choose where you would like breadcrumbs to display.', 'compassbuildingrome-mpw-rome' ),
				'priority'    => 110,
	...
	public function get_options() {
		return apply_filters( 'flagship_breadcrumb_options', array(
			'flagship_breadcrumb_single' => array(
				'default'  => 0,
				'label'    => __( 'Single Entries', 'compassbuildingrome-mpw-rome' ),
			),
			'flagship_breadcrumb_pages' => array(
				'default'  => 0,
				'label'    => __( 'Pages', 'compassbuildingrome-mpw-rome' ),
			),
			'flagship_breadcrumb_blog_page' => array(
				'default'  => 0,
				'label'    => __( 'Blog Page', 'compassbuildingrome-mpw-rome' ),
			),
			'flagship_breadcrumb_archive' => array(
				'default'  => 0,
				'label'    => __( 'Archives', 'compassbuildingrome-mpw-rome' ),
			),
			'flagship_breadcrumb_404' => array(
				'default'  => 0,
				'label'    => __( '404 Page', 'compassbuildingrome-mpw-rome' ),
			),
			'flagship_breadcrumb_attachment' => array(
				'default'  => 0,
				'label'    => __( 'Attachment/Media Pages', 'compassbuildingrome-mpw-rome' ),
			),
		) );
	}
