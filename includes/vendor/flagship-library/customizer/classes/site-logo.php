...
class Flagship_Site_Logo extends Flagship_Customizer_Base {
	...
	public function register( $wp_customize ) {
		...
		$wp_customize->get_section( 'title_tagline' )->title = __( 'Site Title, Tagline, and Logo', 'compassbuildingrome-mpw-rome' );
		...
		$wp_customize->add_control(
			new WP_Customize_Control(
				...
				'site_logo_header_text',
				array(
					'label'    => __( 'Display Header Text', 'compassbuildingrome-mpw-rome' ),
		...
		$wp_customize->add_control(
			new Flagship_Site_Logo_Image_Control(
				...
				'site_logo',
				array(
					'label'    => __( 'Logo', 'compassbuildingrome-mpw-rome' ),
					'section'  => 'title_tagline',
					'settings' => 'site_logo',
				)
			)
	...
	public function add_media_state( $media_states ) {
		...
		if ( $post->ID == $this->logo['id'] ) {
			$media_states[] = __( 'Site Logo', 'compassbuildingrome-mpw-rome' );
		}
		return $media_states;
	}
