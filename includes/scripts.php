...
add_action( 'admin_init', 'compassbuildingrome_add_editor_styles' );
/**
 ...
 * @return void
 */
function compassbuildingrome_add_editor_styles() {
...
add_action( 'wp_enqueue_scripts', 'compassbuildingrome_rtl_add_data' );
/**
 * Replace the default theme stylesheet with a RTL version when a RTL
 * language is being used.
 *
 ...
 * @return void
 */
function compassbuildingrome_rtl_add_data() {
	wp_style_add_data( 'style', 'rtl', 'replace' );
	wp_style_add_data( 'style', 'suffix', hybrid_get_min_suffix() );
}

add_action( 'wp_enqueue_scripts', 'compassbuildingrome_enqueue_styles', 4 );
/**
 ...
 * @return void
 */
function compassbuildingrome_enqueue_styles() {
	wp_register_style(
		'google-fonts',
		'//fonts.googleapis.com/css?family=Raleway:400,600|Lato:400,400italic,700',
		array(),
...
add_action( 'wp_enqueue_scripts', 'compassbuildingrome_enqueue_scripts' );
/**
 ...
 * @return void
 */
function compassbuildingrome_enqueue_scripts() {
