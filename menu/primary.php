...
<?php if ( has_nav_menu( 'primary' ) ) : ?>
	...
	<nav <?php hybrid_attr( 'menu', 'primary' ); ?>>
		...
		<span id="menu-primary-title" class="screen-reader-text">
			...
			printf( _x( '%s', 'nav menu title', 'compassbuildingrome-mpw-rome' ), hybrid_get_menu_location_name( 'primary' ) );
			?>
		</span>
...
<?php elseif ( current_user_can( 'edit_theme_options' ) && ! has_nav_menu( 'secondary' ) ) : ?>
	...
	<div class="header-right">
		<p class="no-menu">
			...
			<?php _e( "Ready to add your primary menu? Let's get started!", 'compassbuildingrome-mpw-rome' ); ?>
			...
			printf(	'<a class="button" href="%1$s">%2$s</a>',
				...
				__( 'Add a Menu', 'compassbuildingrome-mpw-rome' )
			);
			?>
